function[] = SymbolicForwardKinematics()
    ...
    % UTorso to LArm
    nml    = {'';'lclav';'lscap';'luarm';'llarm';'lfarm';'llfarm';'lhand'};
    dl =     [0,-.245,0,0,-.0092,0,.299,0];
    thetal = [pi/2,qr(4),qr(5),qr(6)+pi/2,qr(7),qr(8)+pi/2,qr(9),qr(10)];
    al =     [.2256,.11,0,0,-.119,0,-.0092,0];
    alphal = [-pi/2,pi/2,0,0,pi/2,-pi/2,pi/2,0];

    % UTorso to RArm
    nmr    = {'';'rclav';'rscap';'ruarm';'rlfarm';'rfarm';'rlarm';'rhand'};
    dr =     [0,-.245,0,0,-.0092,0,.299,0];
    thetar = [pi/2,qr(4),qr(5),qr(6)+pi/2,qr(7),qr(8)+pi/2,qr(9),qr(10)];
    ar =     [-.2256,-.11,0,0,-.119,0,.0092,0];
