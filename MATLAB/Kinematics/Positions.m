function[] = Positions()
    ...
    for i = 1:length(PelvisTorso)
        PelvisTorso(i).position = PelvisTorso(i).base(1:3,4) - LFootRFoot(7).base(1:3,4);
    ...
    for i = 1:length(TorsoLArm)
        TorsoLArm(i).position = TorsoLArm(i).base(1:3,4) - LFootRFoot(7).base(1:3,4);
    ...
    for i = 1:length(TorsoRArm)
        TorsoRArm(i).position = TorsoRArm(i).base(1:3,4) - LFootRFoot(7).base(1:3,4);
